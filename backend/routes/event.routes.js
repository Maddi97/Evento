...
router.post('/organizer/:organizerId/events', verifyToken, (req, res) => {
...
router.patch('/organizer/:organizerId/events/:eventId', verifyToken, (req, res) => {
...
router.delete('/organizer/:organizerId/events/:eventId', verifyToken, (req, res) => {
